  ...
  function ib(h) {
      ...
      J(
        ...
        function () {
          m ||
            ...
            0 >= navigator.userAgent.search('MSIE') &&
              P(h._menuButton.childNodes[0], { WebkitFilter: 'invert(0%)', filter: 'invert(0%)' }));
        },
        h.allDOMEventHandlers,
        !0
      );
    ...
    if (h.exportEnabled && h._dropdownMenu) {
      ...
      for (
        ...
        P(v[pa], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }),
          (v[pa].innerHTML = r[pa]);
    } else
      !h._dropdownMenu &&
        h.exportEnabled &&
  ...
  function jb(h) {
    if (!kb) {
      ...
      'undefined' === typeof oa.Chart.creditHref
        ? ((h.creditHref = W('iuuqr;..b`ow`rkr/bnl.')), (h.creditText = W('B`ow`rKR/bnl')))
        : ((m = h.updateOption('creditText')), (v = h.updateOption('creditHref')));
  ...
  var ca = 20,
      ...
      return function (E, N, M) {
        ...
        return (M = N.replace(h, function (l) {
          switch (l) {
            ...
            case 'zzz':
              return (
                (0 < f ? '-' : '+') + X(Math.floor(Math.abs(f) / 60), 2) + X(Math.abs(f) % 60, 2)
              );
            default:
    ...
    ea = function (h, m, v) {
      ...
      for (var K = 0; E && K < E.length; K++)
        if (((m = E[K]), '.' === m && 0 > N)) N = K;
          ...
          0 > N
            ? (M.push(m), '#' === m || '0' === m ? Q++ : ',' === m && T++)
            : (H.push(m), ('#' !== m && '0' !== m) || J++);
        }
      S &&
        ((m = Math.floor(h)),
        (E = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (P = 0 === h ? 0 : 0 === m ? -(Q + E) : String(m).length - Q),
        (F /= Math.pow(10, P)));
      0 > N && (N = K);
      F = (h * F).toFixed(J);
      m = F.split('.');
      ...
      for (S = E = K = J = N = 0; 0 < M.length; )
        if (((m = M.pop()), '#' === m || '0' === m))
          if ((N++, N === Q)) {
            ...
            for (; 0 < $.length; )
              (v = $.pop() + v), S++, 0 === S % E && K === T && 0 < $.length && (v = x + v);
          } else
            0 < F.length ? ((v = F.pop() + v), J++, S++) : '0' === m && ((v = '0' + v), J++, S++),
    ...
    Oa = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ...
        : ((m = h.pageX - h.target.offsetLeft), (v = h.pageY - h.target.offsetTop));
      return { x: m, y: v };
    },
    ab = !0,
    ...
    V = function (h, m, v, r, w, x, F, E, N, M, Q, S, H) {
      ...
      0 < F &&
        ...
        (h.strokeStyle = E),
        h.moveTo(m, v),
        h.rect(m - H, v - H, r - m + 2 * H, w - v + 2 * H),
        h.stroke());
      h.restore();
      !0 === N &&
        (h.save(),
        ...
        try {
          ...
          r =
            'cm' === S.pos[m] || 'um' === S.pos[m]
              ? 0
              : h.width - x[S.fSDec('ld`rtsdUdyu')](S.fSDec('B`ow`rKR!Ush`m')).width;
      ...
      : this.parent &&
        ...
        (null === J
          ...
          : 0 < this.parent.themeOptions[E].length &&
            ((w = Math.min(this.parent.themeOptions[E].length - 1, J)),
  ...
  ba.prototype.dispatchEvent = function (h, m, r) {
    if (h && this._eventListeners[h]) {
      ...
      for (var w = this._eventListeners[h], x = 0; x < w.length; x++)
        w[x].eventHandler.call(w[x].context, m);
    }
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth = m.width - 4 - F * ('center' === this.horizontalAlign ? 2 : 1)),
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? ('top' === this.verticalAlign
            ? ((x = m.y1 + 2), (H = 'top'))
            : 'bottom' === this.verticalAlign && ((x = m.y2 - 2 - M.height), (H = 'bottom')),
          'left' === this.horizontalAlign
            ? (w = m.x1 + 2)
            : 'center' === this.horizontalAlign
            ? (w = m.x1 + m.width / 2 - M.width / 2)
            : 'right' === this.horizontalAlign && (w = m.x2 - 2 - M.width - F),
        ...
        : 'center' === this.verticalAlign &&
          ('left' === this.horizontalAlign
            ? ((w = m.x1 + 2),
              (x = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2)),
              (E = -90),
              (H = 'left'),
              (this.width = M.height),
              (this.height = M.width))
            ...
            ? ((w = m.x2 - 2),
              (x = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2)),
              (E = 90),
              (H = 'right'),
              (this.width = M.height),
              (this.height = M.width))
  ...
  x = Pa.Chart = (function () {
          ...
          if (!this.data[d].axisYType || 'primary' === this.data[d].axisYType)
            if (this.options.axisY && 0 < this.options.axisY.length) {
              ...
              this.axisY.length ||
                ('normal' === this.plotInfo.axisPlacement
                  ? this._axes.push(
                      (this.axisY[0] = new F(this, 'axisY', this.options.axisY, 0, 'axisY', 'left'))
                    )
                  : 'xySwapped' === this.plotInfo.axisPlacement &&
                    this._axes.push(
                      (this.axisY[0] = new F(
            ...
            if (this.options.axisX && 0 < this.options.axisX.length) {
              ...
              this.axisX.length ||
                ('normal' === this.plotInfo.axisPlacement
                  ...
                  : 'xySwapped' === this.plotInfo.axisPlacement &&
                    this._axes.push(
                      (this.axisX[0] = new F(this, 'axisX', this.options.axisX, 0, 'axisX', 'left'))
                    )),
    ...
    m.prototype.renderElements = function () {
      ...
      if ('normal' === this.plotInfo.axisPlacement || 'xySwapped' === this.plotInfo.axisPlacement)
        F.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement);
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
          ...
          t.targetCanvas = null;
          this.animatedRender &&
            ((t.targetCanvas = sa(this.width, this.height)),
    ...
    m.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (c = 0; c < b.length; c++)
        if (
          ...
          if (
            ((e = ka('markerSize', b[c].dataPoint, b[c].dataSeries) || 8), b[c].distance <= e / 2)
          ) {
            d = !0;
            break;
          }
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var m = ka('indexLabelLineDashType', n.dataPoint, n.dataSeries),
          ...
          z = r(n.dataPoint.indexLabelLineThickness)
        ...
        if (null !== D && '' !== D) {
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            ...
            'inside' !== y
              ? ((e = c.y1),
                (f = c.y2),
                0 < v
                  ? ((g = n.point.y + ('horizontal' === C ? s / 2 : 0) - k - t - b),
                    g < e &&
                      ((g = 'auto' === y ? Math.max(n.point.y, e) + s / 2 + t : e + s / 2 + t),
                      (x = g + k > n.point.y)))
                  : ((g = n.point.y + s / 2 + t + b),
                    g > f - k &&
                      ((g = 'auto' === y ? Math.min(n.point.y, f) + s / 2 - k - t : f + s / 2 - k),
                      (x = g < n.point.y))))
            ...
            0 <= p.indexOf('line') || 0 <= p.indexOf('area') || 0 <= p.indexOf('scatter')
              ...
              'inside' !== y
                ? ((e = c.x1),
                  (f = c.x2),
                  0 > v
                    ? ((q = n.point.x - ('horizontal' === C ? B : B - s / 2) - l - b),
                      q < e &&
                        ((q = 'auto' === y ? Math.max(n.point.x, e) + l : e + l),
                        (x = q + B > n.point.x)))
                    : ((q = n.point.x + ('horizontal' === C ? 0 : s / 2) + l + b),
                      q > f - B - l - b &&
                        ((q =
                          'auto' === y
                            ? Math.min(n.point.x, f) - ('horizontal' === C ? B : B / 2) - l
                            : f - B - l),
                        (x = q < n.point.x))))
                : ((e = Math.max(n.bounds.x1, c.x1)),
                  ...
                  (q =
                    0 > v
                      ? Math.max(n.point.x, b) - ('horizontal' === C ? B / 2 : 0)
                      : Math.min(n.point.x, b) - B / 2),
                  (q = Math.max(q, e)));
          'vertical' === C && (g += k - s / 2);
          h.x = q;
          h.y = g;
          ...
          z &&
            ...
            0 <= p.indexOf('bar') || ('error' === p && n.axisSwapped)
              ? d.lineTo(
                  q + (0 < n.direction ? -l : B + l) + ('vertical' === C ? -s / 2 : 0),
                  g + ('vertical' === C ? -k / 2 : k / 2 - s / 2) - t
                )
              : 0 <= p.indexOf('column') || ('error' === p && !n.axisSwapped)
              ? d.lineTo(
                  q + B / 2 - ('horizontal' === C ? 0 : s / 2),
                  g +
                    ('vertical' === C
                      ? (g - k < n.point.y ? 0 : -k) + t
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < n.length) {
            for (var C = !1, u = 0; u < n.length; u++)
              if (
                ((z = n[u].x.getTime ? n[u].x.getTime() : n[u].x),
                !(
                  z < a.axisX.dataInfo.viewPortMin ||
                  (z > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C))
                ))
              )
                if ('number' !== typeof n[u].y)
                  0 < u && !(k.connectNullData || C || m) && (c.stroke(), w && b.stroke()),
                    (C = !0);
                else {
                  ...
                  m || C
                    ...
                    : (c.lineTo(z, r),
                      ...
                      0 == u % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(z, r),
                        w && (b.stroke(), b.beginPath(), b.moveTo(z, r))));
                  l = { x: z, y: r };
                  u < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[u].lineDashType
                        ? ((p = n[u].lineDashType), c.setLineDash(N(p, k.lineThickness)))
            ...
            for (var C = !1, u = 0; u < n.length; u++)
              if (
                ...
                !(
                  ...
                  (r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C))
                ))
              )
                if ('number' !== typeof n[u].y)
                  0 < u && !(k.connectNullData || C || m) && (c.stroke(), w && b.stroke()),
                  ...
                  u < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[u].lineDashType
                        ...
                        : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < n[u].markerSize || 0 < k.markerSize)
                    (D = k.getMarkerProperties(u, r, y, c)),
                      f.push(D),
                      (A = Q(A)),
                      w &&
                        f.push({
            ...
            for (r = !1, m = 0; m < n.length; m++)
              if (
                ...
                !(
                  ...
                  (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !r))
                ))
              )
                if ('number' !== typeof n[m].y)
                  0 < m &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        0 < y.length &&
                        (k.options.nullDataLineDashType || !n[m - 1].lineDashType) &&
                        ((y[y.length - 1].newLineDashArray = q), (p = k.nullDataLineDashType))
                      : (d(y), (y = []))),
                    (r = !0);
                else {
                  ...
                  m < n.length - 1 &&
                    ...
                    b.setLineDash &&
                      (n[m].lineDashType
                        ? ((p = n[m].lineDashType),
                          (y[y.length - 1].newLineDashArray = N(p, k.lineThickness)))
                        : ((p = k.lineDashType), (y[y.length - 1].newLineDashArray = g))));
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < s.length)
            for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
              if (
                (s[f].getTime ? (B = s[f].x.getTime()) : (B = s[f].x),
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                V(
                  ...
                  0,
                  null,
                  r && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y),
                  (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && r,
                  !1,
                  !1,
                  m.fillOpacity
                );
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (t[b] = u[k].y + (t[b] ? t[b] : 0)),
                    0 < t[b] &&
                      ((D = f[b] ? f[b] : q), (f[b] = n = a.axisY.convertValueToPixel(t[b])));
                else if (
                  a.axisY.scaleBreaks &&
                  0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                  0 >= u[k].y
          ...
          if (0 < s.length) {
            ...
            for (var ja = !0; h < s.length; h++)
              if (
                ...
                !(
                  r < a.axisX.dataInfo.viewPortMin ||
                  (r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja))
                ))
              )
                if ('number' !== typeof s[h].y) g.connectNullData || ja || d || b(), (ja = !0);
                  ...
                  h < s.length - 1 &&
                    ...
                    f.setLineDash &&
                      (s[h].lineDashType
                        ? ((c = s[h].lineDashType), f.setLineDash(N(c, g.lineThickness)))
                  ...
                  0 !== s[h].markerSize &&
                    ...
                    ((r = g.getMarkerProperties(h, m, u, f)),
                    B.push(r),
                    (Y = Q(Y)),
                    w &&
                      B.push({
            ...
            for (s = !1; q < p.length; q++)
              if (
                ...
                !(
                  ...
                  (g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !s))
                ))
              )
                if ('number' !== typeof p[q].y)
                  0 < q &&
                    ...
                    (n.connectNullData
                      ? b.setLineDash &&
                        ...
                        ((r[r.length - 1].newLineDashArray = x), (A = n.nullDataLineDashType))
                      : (d(), (r = []))),
                    (s = !0);
                else {
                  ...
                  q < p.length - 1 &&
                    ...
                    b.setLineDash &&
                      (p[q].lineDashType
                        ? ((A = p[q].lineDashType),
                          (r[r.length - 1].newLineDashArray = N(A, n.lineThickness)))
                        : ((A = n.lineDashType), (r[r.length - 1].newLineDashArray = F))));
          ...
          if (0 < s.length) {
            ...
            for (; h < s.length; h++)
              if (
                ...
                !(
                  r < a.axisX.dataInfo.viewPortMin ||
                  (r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))
                ))
              ) {
                var Y = u;
                'number' !== typeof s[h].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(r)),
                    ...
                    h < s.length - 1 &&
                      (x !== (s[h].lineColor || v) ||
                        R !== (s[h].lineDashType || g.lineDashType)) &&
                      (b(),
                      (x = s[h].lineColor || v),
                      (f.strokeStyle = x),
                      f.setLineDash &&
                        (s[h].lineDashType
                          ? ((R = s[h].lineDashType), f.setLineDash(N(R, g.lineThickness)))
                          : ((R = g.lineDashType), f.setLineDash(F)))),
                    (r = g.dataPointIds[h]),
                    (this._eventManager.objectMap[r] = {
                      id: r,
                      objectType: 'dataPoint',
                    ...
                    0 !== s[h].markerSize &&
                      (0 < s[h].markerSize || 0 < g.markerSize) &&
                      ((Y = g.getMarkerProperties(h, m, u, f)),
                      B.push(Y),
                      (r = Q(r)),
                      w &&
                        B.push({
                ...
                if ('number' !== typeof fa.y) A.connectNullData || Y || z || d(), (Y = !0);
                  ...
                  z || Y
                    ...
                    : (b.lineTo(g, s),
                      w && r.lineTo(g, s),
                      0 == q % 250 &&
                        (d(), b.moveTo(g, s), w && r.moveTo(g, s), k.push({ x: g, y: m - la })));
                  u = { x: g, y: s };
                  q < v.length - 1 &&
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((y = v[q].lineDashType), b.setLineDash(N(y, A.lineThickness)))
                        : ((y = A.lineDashType), b.setLineDash(F))));
                  ...
                  0 <= A.dataPointIndexes[f] &&
                    ...
                    ((la = A.getMarkerProperties(A.dataPointIndexes[f], g, s, b)),
                    l.push(la),
                    (f = Q(E)),
                    w &&
                      l.push({
                ...
                if ('number' !== typeof fa.y) A.connectNullData || Y || r || d(), (Y = !0);
                  ...
                  r || Y
                    ...
                    : (b.lineTo(g, s),
                      w && y.lineTo(g, s),
                      0 == q % 250 &&
                        (d(), b.moveTo(g, s), w && y.moveTo(g, s), k.push({ x: g, y: z - E })));
                  m = { x: g, y: s };
                  q < v.length - 1 &&
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((u = v[q].lineDashType), b.setLineDash(N(u, A.lineThickness)))
                  ...
                  0 <= A.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < A.markerSize) &&
                    ((E = A.getMarkerProperties(q, g, s, b)),
                    t.push(E),
                    (f = Q(G)),
                    w &&
                      t.push({
    ...
    m.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var s = 25 * Math.PI,
            m = Math.max(Math.pow((0.25 * Math.min(b.height, b.width)) / 2, 2) * Math.PI, s),
            k = 0;
          k < a.dataSeriesIndexes.length;
          k++
        )
              ...
              if (
                ...
                var g = q[e].z,
                  r =
                    2 *
                    Math.max(
                      Math.sqrt((t === h ? m / 2 : s + ((m - s) / (t - h)) * (g - h)) / Math.PI) <<
                        0,
                      1
                    ),
                ...
                'candlestick' === u.type
                  ? (c.moveTo(h - x, n),
                    ...
                    V(
                      ...
                      v,
                      Math.max(k, q),
                      z[t].y[0] <= z[t].y[3] ? u.risingColor : f,
                      A,
                      e,
                      y,
                      y,
            ...
            for (var C = 5 < s && z.bevelEnabled ? !0 : !1, l = 0; l < y.length; l++)
              if (
                ...
                w &&
                  ...
                  0 < Ba &&
                    (b.moveTo(t - F - G, k),
                    b.lineTo(t - F - G, Math.max(h, p)),
                    b.stroke(),
                    b.moveTo(t - F - G, Math.min(h, p)),
                    b.lineTo(t - F - G, n),
                    b.stroke()),
          ...
          if (A)
            for (e = C._linkedSeries.id, u = 0; u < e; u++)
              !this.data[u].type.match(/(bar|column)/gi) ||
                ...
                (this.data[u].type.match(/(range)/gi) && (f = !0), F++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          if (0 < D.length)
            for (var E = C._colorSet, t = 0; t < D.length; t++) {
              ...
              R.length =
                'number' === typeof R.length
                  ? 0 >= R.length
                    ...
                    ? u
                    : R.length
                  : 'string' === typeof R.length
                  ? (parseInt(R.length) * u) / 100 > u
                    ? u
                    : (parseInt(R.length) * u) / 100 > u
                  : u;
              R.thickness =
              ...
              if (
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((A ? v : 1) * u) / 2 - (A ? F - 1 : 0) * u) << 0
                      : (k - ((A ? v : 1) * u) / 2 + (A ? F - 1 : 0) * u) << 0),
                    (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((n = a.axisX.reversed
                      ? (h + ((A ? v : 1) * u) / 2 - (A ? F - 1 : 0) * u) << 0
                      : (h - ((A ? v : 1) * u) / 2 + (A ? F - 1 : 0) * u) << 0),
          ...
          if (0 < p.length) {
            ...
            for (var R = !0; g < p.length; g++)
              if (
                ...
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !R))
                ))
              )
                if (
                  null !== p[g].y &&
                  ...
                  g < p.length - 1 &&
                    ...
                    b.setLineDash &&
                      (p[g].lineDashType
                        ? ((A = p[g].lineDashType),
                          (h[h.length - 1].newLineDashArray = N(A, n.lineThickness)),
                ...
                if (
                  ...
                  p < n.length - 1 &&
                    ...
                    b.setLineDash &&
                      (n[p].lineDashType
                        ? ((C = n[p].lineDashType),
                          (r[r.length - 1].newLineDashArray = N(C, k.lineThickness)))
                        : ((C = k.lineDashType), (r[r.length - 1].newLineDashArray = D))));
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        ((r[r.length - 1].newLineDashArray = A), (C = k.nullDataLineDashType))
                      : (d(D, z), (r = []), (x = []))),
                    (g = !0);
            d(D, z);
            $.drawMarkers(f);
    ...
    m.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          l > m &&
          (l = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          m < l &&
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < v.length)
            for (
              var y = 5 < q && r.bevelEnabled ? !0 : !1, C = !1, D = null, A = null, l = 0;
              l < v.length;
              l++
            )
              if (
                (v[l].getTime ? (n = v[l].x.getTime()) : (n = v[l].x), 'number' !== typeof v[l].y)
              ) {
                if (0 < l && !C && r.connectNullData)
                  var x =
                    r.options.nullDataLineDashType || !v[l - 1].lineDashType
                ...
                0 < l &&
                  D &&
                  (!C || r.connectNullData) &&
                  (C && c.setLineDash && c.setLineDash(N(x, u)),
                  c.beginPath(),
                  c.moveTo(D, A - z),
                  c.lineTo(R, aa - z),
                  0 < u && c.stroke(),
                  w &&
                    (b.beginPath(), b.moveTo(D, A - z), b.lineTo(R, aa - z), 0 < u && b.stroke()));
                C = !1;
                D = F;
                A = 0 < v[l].y ? m : k;
                R = v[l].lineDashType
          ...
          if (d > c) {
            ...
            if (n[b].exploded) {
              if (
                ...
                (g[b].center.x = y.x + e * a), (g[b].center.y = y.y + f * a), (l = !0);
            } else if (0 < Math.abs(g[b].center.x - y.x) || 0 < Math.abs(g[b].center.y - y.y))
              (g[b].center.x = y.x + e * (1 - a)), (g[b].center.y = y.y + f * (1 - a)), (l = !0);
            l &&
              ((e = {}),
              (e.dataSeries = k),
            ...
            ? ((h = 'right' === p.hemisphere ? t : q),
              ...
              null !== h &&
                ...
                c - t < s &&
                  ((k = -t),
                  (h = f(h, k, d + 1)),
                  +h.toFixed(z) > +k.toFixed(z) && (l = c > s ? -(c - s) : -(t - (h - k))))))
            : 0 < c &&
              ...
              null !== h &&
                ...
                c - t < s &&
                  ((k = t),
                  (h = f(h, k, d + 1)),
                  +h.toFixed(z) < +k.toFixed(z) && (l = c > s ? c - s : t - (k - h)))));
          l &&
            ...
            for (var t, r, a = 0; a < n.length; a++) {
              ...
              if (null !== u) {
                ...
                var C = 0,
                  C = b(t, r) - s;
                if (0 > C) {
                  for (var D = (r = 0), E = 0; E < n.length; E++)
                    E !== a &&
                      g[E].hemisphere === h.hemisphere &&
                      (g[E].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ : D++);
                  r = (C / (r + D || 1)) * D;
                  var D = -1 * (C - r),
                    J = (E = 0);
                  'right' === h.hemisphere
                    ? ((E = f(a, r)),
                      (D = -1 * (C - E)),
                      (J = f(u, D)),
                      +J.toFixed(z) < +D.toFixed(z) &&
                        +E.toFixed(z) <= +r.toFixed(z) &&
                        f(a, -(D - J)))
                    : ((E = f(u, r)),
                      (D = -1 * (C - E)),
                      (J = f(a, D)),
            ...
            if (
              ...
              (u = u = 0),
                ...
                0 < u &&
                  ...
                  Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - y.y) < A ||
                    Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - y.y) <
                      A) &&
                ...
                0 < u &&
                  (!l &&
                    ...
                    0 === f(a, u * r) && f(a, 2 * r)),
                  Math.abs(h.indexLabelTextBlock.x - y.x) < A &&
    ...
    m.prototype.renderFunnel = function (a) {
        ...
        if (u && z) {
          ...
          for (var A = 0, D = z.length - 1; A < z.length || 0 <= D; A++, D--) {
            ...
            a = b.color
              ? b.color
              : u.reversed
              ? u._colorSet[(z.length - 1 - A) % u._colorSet.length]
        ...
        if (e)
          for (l = I.length - 1; 0 <= l; l--)
            (a = O[l]),
              ...
              u.reversed
                ? (I[l].textBlock.y + I[l].height > ma + C &&
                    (I[l].textBlock.y = ma + C - I[l].height),
                  I[l].textBlock.y < ra - C && (I[l].textBlock.y = ra - C))
                : (I[l].textBlock.y < ma - C && (I[l].textBlock.y = ma - C),
                  I[l].textBlock.y + I[l].height > ra + C &&
                    (I[l].textBlock.y = ra + C - I[l].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < O.length; e++)
            0 == I[e].textBlock.text.length
              ...
              : ((a = O[e]),
                ...
                u.reversed
                  ? (I[e].textBlock.y + I[e].height > ma + C &&
                      (I[e].textBlock.y = ma + C - I[e].height),
                    I[e].textBlock.y < ra - C && (I[e].textBlock.y = ra - C))
                  : (I[e].textBlock.y < ma - C && (I[e].textBlock.y = ma - C),
                    I[e].textBlock.y + I[e].height > ra + C &&
                      (I[e].textBlock.y = ra + C - I[e].height)));
        else
      ...
      function h(a, b) {
        return (
          (b < O.length ? I[b].textBlock.y : u.reversed ? ma + C : ra + C) -
          (0 > a ? (u.reversed ? ra - C : ma - C) : I[a].textBlock.y + I[a].height + da)
        );
      }
      function m(a, b, c) {
        var d,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]],
            ...
            A = 0,
            F = y.height - 2 * C,
            E = Math.min(y.width - 2 * D, 2.8 * y.height),
            J = !1,
            H = 0;
          H < z.length;
          H++
          ...
          if (
            (!J &&
              'undefined' !== typeof z[H].indexLabel &&
              null !== z[H].indexLabel &&
              0 < z[H].indexLabel.toString().length &&
              (J = !0),
            !J &&
              'undefined' !== typeof z[H].label &&
              null !== z[H].label &&
              0 < z[H].label.toString().length &&
              (J = !0),
            (!J && 'function' === typeof u.indexLabelFormatter) ||
              'function' === typeof z[H].indexLabelFormatter)
          )
            J = !0;
        J =
          J ||
          ...
          if (-1 !== H) {
            ...
            if (u.reversed)
              for (G = 0; G < H.length; G++)
                E[G] < wa
                  ? (a.push(L), D.push(ba), (ca = G))
                  : (a.push((E[G] - ma + V * U) / V), D.push((E[G] - ma + ea * $) / ea));
            else
              for (G = 0; G < H.length; G++)
                E[G] < wa
                  ? (a.push((E[G] - ma + V * U) / V), D.push((E[G] - ma + ea * $) / ea), (ca = G))
                  : (a.push(L), D.push(ba));
            for (G = 0; G < H.length - 1; G++)
              (Z = u.reversed
                ? z[z.length - 1 - G].color
                  ? z[z.length - 1 - G].color
                  : u._colorSet[(z.length - 1 - G) % u._colorSet.length]
                : z[G].color
                ? z[G].color
            ...
            for (G = 0; G < z.length; G++)
              z[G].exploded && ((H = !0), u.reversed ? W.push(z.length - 1 - G) : W.push(G));
            ...
            J &&
              u.visible &&
              ('inside' === u.indexLabelPlacement || x.animationEnabled || n(T),
            ...
            this.funnelPyramidClickHandler = function (a) {
              ...
              if (
                ...
                !x.isAnimating &&
                (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                ((b = u.reversed ? z.length - 1 - a.dataPointIndex : a.dataPointIndex), 0 <= b)
              ) {
                a = b;
                if ('funnel' === u.type || 'pyramid' === u.type)
                  u.reversed
                    ? (z[z.length - 1 - a].exploded = z[z.length - 1 - a].exploded ? !1 : !0)
    ...
    m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace(
            '#total',
            ea(h, c.yValueFormatString ? c.yValueFormatString : '#,##0.########', f._cultureInfo)
          );
          ...
          if (q) {
            switch (this.type) {
              ...
              case 'scatter':
                ...
                s <= w &&
                  b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: s });
                q = Math.abs(q.x1 - a);
                q <= m ? (m = q) : 0 < l ? k++ : n++;
                s <= r / 2 && (h = !0);
                break;
              ...
              case 'pyramid':
                ...
                d > s.y1 &&
                  ...
                  (s.y6
                    ? d > s.y6
                      ? ((f = s.x6 + ((s.x5 - s.x6) / (s.y5 - s.y6)) * (d - s.y6)),
                        (s = s.x3 + ((s.x4 - s.x3) / (s.y4 - s.y3)) * (d - s.y3)))
                      : ((f = s.x1 + ((s.x6 - s.x1) / (s.y6 - s.y1)) * (d - s.y1)),
                        (s = s.x2 + ((s.x3 - s.x2) / (s.y3 - s.y2)) * (d - s.y2)))
                    : ((f = s.x1 + ((s.x4 - s.x1) / (s.y4 - s.y1)) * (d - s.y1)),
                      (s = s.x2 + ((s.x3 - s.x2) / (s.y3 - s.y2)) * (d - s.y2))),
                  a > f &&
                    a < s &&
                    (b.push({
        ...
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (
            ...
            s[w].endValue < q[g].viewportMinimum ||
              (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w),
              s[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
      for (
        var v = (w = 0),
          u = 0,
          z = 0,
      ...
      if ('normal' === e) {
        for (var z = [], y = [], x = [], D = [], M = [], N = [], P = [], Q = []; 4 > w; ) {
                ...
                !a[g] ||
                  ...
                  0 < a[g].labelAngle
                    ...
                    ? A - v < l &&
                      ...
                      (E = l - (L + a[g].tickLength + x + A - v + a[g].labelFontSize / 2))
                    : 0 === a[g].labelAngle &&
                      (F + u > m && (h = F + u / 2 - m - $),
                      A - v < l &&
                        A - v < a[g].viewportMinimum &&
                        (E = l - L - a[g].tickLength - x - A + v / 2)),
          ...
          if (0 < w) {
            ...
            if (b && 0 < b.length)
              for (g = 0; g < b.length; g++) K = Q[w - 1][g] === Q[w][g] ? !0 : !1;
            else K = !0;
          }
          if (s && H && J && K) break;
          w++;
                  ...
                  (0 < !a.length &&
                    (l =
                      0 > c[g].labelAngle
                        ...
                        : l),
                  0 < !d.length &&
                    (m = 0 < c[g].labelAngle ? m - y / 2 : 0 === c[g].labelAngle ? m - y / 2 : m)),
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              (b[g].lineCoordinates = {}),
                (l = Math.round(f.x1 + X + e)),
                (m = Math.round(
                  f.x2 - U - W > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - W
                )),
                b[g] &&
                  b[g].labelAutoFit &&
                  !r(x) &&
          ...
          if (a && 0 < a.length)
            for (g = 0; g < a.length; g++) {
                  ...
                  c[L] &&
                    ...
                    ((m =
                      0 > c[L].labelAngle
                        ...
                        ? Math.max(m, z / 2)
                        : m),
                    (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - X : l));
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] && b[L].labelAutoFit && ((m = b[L].lineCoordinates.x1), (l = m - X));
              a[g].lineCoordinates = {
                x1: m - P,
                y1: h,
                x2: m - P,
              ...
              'inside' === a[g].labelPlacement &&
                ...
                ((a[g].lineCoordinates.x1 =
                  a[g].lineCoordinates.x1 -
                  (E[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) +
                  ...
                  c[L] &&
                    ...
                    ((m =
                      0 > c[L].labelAngle
                        ...
                        ? Math.max(m, z / 2)
                        : m),
                    (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - U : l));
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] && b[L].labelAutoFit && ((m = b[L].lineCoordinates.x2), (l = m - U));
              d[g].lineCoordinates = {
                x1: m + Q,
                y1: h,
                x2: m + Q,
    ...
    F.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
            ...
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * T.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(F.getNiceNumber(b / (a - 1), !0) / T.yearDuration)),
        ...
        this.valueFormatString ||
          (this.valueFormatString = F.generateValueFormatString(this.range, 2));
      }
    };
    F.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      this.options && 0 < this.options.interval
        ...
        : ((this.interval = F.getNiceExponent(Math.log(l) / d / (a - 1), !0)),
          (c = F.getNiceNumber(h / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          'axisX' === this.type
            ? b / Math.sqrt(f)
      ...
      1 === this.viewportMaximum &&
        ...
        this.options &&
          'undefined' === typeof this.options.interval &&
          ((this.interval = F.getNiceExponent(Math.ceil(Math.log(l) / d) / (a - 1))),
          (c = F.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
      if (null === this.minimum || null === this.maximum)
        'axisX' === this.type
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            'top' === this.scaleBreaks.parent._position
              ? ((e = this.chart.plotArea.y1), (m = (this.chart.plotArea.y2 + p / 2 + 0.5) << 0))
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          if ('rangeBar' === n[0].dataSeries.type || 'error' === n[0].dataSeries.type)
            for (
              var v = Math.abs(a - this.parent.convertValueToPixel(n[x].dataPoint.y[0])),
                u = 0,
                s = 0;
              s < n.length;
              s++
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (var z = 0; z < n[s].dataPoint.y.length; z++)
                  (u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[z]))),
                    u < v && ((v = u), (x = s));
              else
                (u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y))),
                  u < v && ((v = u), (x = s));
          else if ('stackedBar' === n[0].dataSeries.type)
            for (
              var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                y = (u = 0),
                s = (x = 0);
              s < n.length;
              s++
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (z = 0; z < n[s].dataPoint.y.length; z++)
                  (u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[z]))),
                    u < v && ((v = u), (x = s));
              else
                (y += n[s].dataPoint.y),
            ...
            for (
              v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = x = u = 0;
              s < n.length;
              s++
            )
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
          ...
          if ('bottom' === this.parent._position || 'top' === this.parent._position) {
            ...
            if (
              ...
              for (s = u = 0; s < z.dataPoint.y.length; s++)
                (u = Math.abs(a - this.parent.convertValueToPixel(z.dataPoint.y[s]))),
                  u < v && ((v = u), (b = s));
              m =
                1 === q.lineWidth % 2
                  ? (this.parent.convertValueToPixel(z.dataPoint.y[b]) << 0) + 0.5
                  : this.parent.convertValueToPixel(z.dataPoint.y[b]) << 0;
              ...
              (m =
                1 === q.lineWidth % 2
                  ? (this.parent.convertValueToPixel(z.dataPoint.y) << 0) + 0.5
                  : this.parent.convertValueToPixel(z.dataPoint.y) << 0),
            ...
            f =
              ...
              w =
                1 === q.lineWidth % 2
                  ? (this.parent.convertValueToPixel(z.dataPoint.x) << 0) + 0.5
                  : this.parent.convertValueToPixel(z.dataPoint.x) << 0;
            ...
            if (C) {
              if ('axisX' === this.parent.type)
                for (
                  s = this.parent.convertPixelToValue({ y: d }), v = null, x = 0;
          ...
          if (
            ...
            for (
              v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), s = u = 0;
              s < n.length;
              s++
            )
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (z = 0; z < n[s].dataPoint.y.length; z++)
                  (u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[z]))),
                    u < v && ((v = u), (x = s));
              else
                (u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y))),
                  u < v && ((v = u), (x = s));
          else if (
            ...
            for (
              v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = y = u = 0;
              s < n.length;
              s++
            )
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
            ...
            for (
              v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = u = 0;
              s < n.length;
              s++
            )
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
          ...
          if (
            ...
            for (s = u = 0; s < z.dataPoint.y.length; s++)
              (u = Math.abs(d - this.parent.convertValueToPixel(z.dataPoint.y[s]))),
                u < v && ((v = u), (b = s));
            w =
              1 === q.lineWidth % 2
                ? (this.parent.convertValueToPixel(z.dataPoint.y[b]) << 0) + 0.5
            ...
            'waterfall' === this.parent.dataSeries[x].type
              ? ((w =
                  1 === q.lineWidth % 2
                    ? (this.parent.convertValueToPixel(
                        z.dataSeries.dataPointEOs[z.index].cumulativeSum
                      ) <<
                        0) +
                      0.5
                    : this.parent.convertValueToPixel(
                ...
                (k.text = this.labelFormatter
                  ...
                  : r(this.options.label)
                  ? ea(
                      c ? c : z.dataSeries.dataPointEOs[z.index].cumulativeSum,
                      this.valueFormatString,
              ...
              : ((w =
                  1 === q.lineWidth % 2
                    ? (r(a) ? d : this.parent.convertValueToPixel(z.dataPoint.y) << 0) + 0.5
                    : r(a)
                    ? d
                    : this.parent.convertValueToPixel(z.dataPoint.y) << 0),
                (k.text = this.labelFormatter
    ...
    var K = {
        ...
        xClipAnimation: function (a, d) {
          if (0 !== a) {
            ...
            c.save();
            0 < a &&
              c.drawImage(b, 0, 0, b.width * a, b.height, 0, 0, (b.width * a) / ga, b.height / ga);
            c.restore();
          }
        },
